...
# Ingest
datasource = datasources.VismaDataSources.SALESORDER
...
input_df = (
    ...
    .json(json_files)
    .withColumn("lines", F.explode_outer("lines"))
    .withColumn(
        "_page_number",
...
# Flatten Dataframe
flatten_df = etl_tools.flatten_struct_columns(coalesced_df, flatten_cols=['lines', 'customer'], explode_arrays=False)
...
final_df = etl_tools.add_meta(dedup_df)
