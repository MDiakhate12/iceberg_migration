...
desti = 'matomo_visitorinterest_duration'
method = 'append'

# EXTRACT

df = fetch_matomo_api_records(spark, env, db, mato, "VisitorInterest.getNumberOfVisitsPerVisitDuration", None, desti, method)
